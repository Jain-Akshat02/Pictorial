    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: "1.5rem", marginBottom: "15px" }}>Your Gallery is Empty</p>
          <p style={{ fontSize: "1rem", opacity: 0.8, lineHeight: "1.6" }}>
            Start your visual journey by uploading your first photo. Share your moments with the world!
          </p>
        </div>
      </div>
    );
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            A collection of your captured moments, each telling its own unique story
          </p>
        </div>
              ...
              <div style={{
                ...
                <img
                  ...
                  style={{
                    ...
                    transform: hoveredImage === image._id ? "scale(1.05)" : "scale(1)"
                  }}
                />
                <div style={{
                  position: "absolute",
                  ...
                  <div style={{
                    color: "white",
                    transform: `translateY(${hoveredImage === image._id ? "0" : "20px"})`,
              ...
              <div style={{
                ...
                {image.description && (
                  <p style={{
                    ...
                    transition: "all 0.3s ease",
                    transform: hoveredImage === image._id ? "translateY(-5px)" : "translateY(0)",
                    opacity: hoveredImage === image._id ? 1 : 0.8
                  }}>
                    {image.description}
                  </p>
                )}
